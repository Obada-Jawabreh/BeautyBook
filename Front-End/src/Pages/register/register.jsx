...
import register from "./../../assets/images/login.jfif";

const primaryColor = "bg-prim-button hover:bg-hover-button text-white";
const inputClasses = "border border-[#FFA8B9] rounded-md px-4 py-2 w-full focus:outline-none"; 
    ...
    <div className="flex h-screen bg-[#FFFAF0]">
      <div className="w-full md:w-1/2 flex items-center justify-center">
        <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-md">
          <h2 className="text-2xl font-bold text-[#FFA8B9] mb-4">Register for BeautyBook</h2>
          <form onSubmit={handleSubmit} className="space-y-4"> {/* إضافة مسافة موحدة بين الحقول */}
            <div>
          ...
          <p className="mt-4 text-center">
            ...
            <Link to="/login" className="text-[#FFA8B9] font-semibold">
              Login here
            </Link>
          </p>
        </div>
